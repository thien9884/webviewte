class PointNotiModel {
  List<RewardPointsNoti>? rewardPoints;
  ...
  PointNotiModel.fromJson(Map<String, dynamic> json) {
    if (json['RewardPoints'] != null) {
      rewardPoints = <RewardPointsNoti>[];
      json['RewardPoints'].forEach((v) {
        rewardPoints!.add(RewardPointsNoti.fromJson(v));
      });
    }
...
class RewardPointsNoti {
  ...
  RewardPointsNoti.fromJson(Map<String, dynamic> json) {
    points = json['Points'];
